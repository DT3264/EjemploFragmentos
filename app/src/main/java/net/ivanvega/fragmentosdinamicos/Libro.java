...
public class Libro {
    ...
    static{
        ...
        final String link4 = "https://file-examples-com.github.io/uploads/2017/11/file_example_MP3_5MG.mp3";
        ...
        libros.add(new Libro("Divina Comedia", "Dante", R.drawable.divina_comedia, link3, Libro.G_EPICO, false, true));
        ...
        libros.add(new Libro("Matrimonio de sabuesos", "Agata Christie", R.drawable.matrim_sabuesos, link2, Libro.G_SUSPENSE, true, false));
        libros.add(new Libro("La iliada", "Homero", R.drawable.la_iliada, link3, Libro.G_EPICO, true, false));
    }
